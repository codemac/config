...
defbindings("WScreen", {
    ...
    kpress(META.."Up", "ioncore.exec_on(_, 'amixer sset Master 3%+')"),
    bdoc("Decrease Volume."),
    kpress(META.."Down", "ioncore.exec_on(_, 'amixer sset Master 3%-')")
})
...
--    kpress(META.."F1", "ioncore.exec_on(_, ':man ion3')"),
    ...
    kpress(ALTMETA.."F2", "ioncore.exec_on(_, 'urxvt')"),
...
defbindings("WFrame.toplevel", {
    ...
    kpress(META.."W", "autoprop(_sub, _, true)", "_sub:WClientWin"),
  
    kpress(META.."V", "autoprop(_sub, nil, X)"),
