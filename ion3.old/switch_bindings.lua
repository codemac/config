...
-- disable the keybindings by pressing MOD1+F8. All the subsequent keystrokes
-- will be sent to the application, until you press MOD1+F8 again, at which
...
local alternate = {
	WScreen = {
		kpress(MOD1.."F8", "toggle_bindings()"),
	}
}
