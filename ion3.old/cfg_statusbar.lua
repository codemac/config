...
mod_statusbar.create{
    ...
    template="%systray[ %mpd v:%volume_level %volume_state ]%filler[ %maildir_INBOX_new \\ %cpuspeed : %load \\ %linuxbatt_state%linuxbatt%linuxbatt_state \\ %date ]",
}
...
mod_statusbar.inform("date_hint", "green")
