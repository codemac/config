...
defbindings("WIonWS", {
    kpress(MOD1..UP.."+Shift", "WIonWS.goto_dir(_, 'above')"),
    kpress(MOD1..DOWN.."+Shift", "WIonWS.goto_dir(_, 'below')"),
    kpress(MOD1..LEFT.."+Shift", "WIonWS.goto_dir(_, 'left')"),
    kpress(MOD1..RIGHT.."+Shift", "WIonWS.goto_dir(_, 'right')"), })
