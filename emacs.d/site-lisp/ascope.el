...
;; database.
;;Another cscope interface called bscope can get the search result quick but it is weak in the presentation of search result. ;;This script merge the xcscope.el and bscope.el together make it fast and versatile
...
(defvar ascope-database-args "-fcscope.out"
  "-fsomedb")
...
(defun ascope-init (dir)
  ...
  (start-process "ascope" "*ascope*" "cscope" "-ld" "-fcscope.out.a" "-fcscope.out.b" "-fcscope.out.c" "-fcscope.out.d" "-fcscope.out.e" "-fcscope.out.f" "-fcscope.out.g" "-fcscope.out.h")
