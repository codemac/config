...
(defun smtpmail-multi-change (account)
  ...
  (let ((settings (cdr (assoc account smtpmail-multi-accounts))))
    ...
    (progn
      (message "smtpmail-smtp-user %s" smtpmail-smtp-user)
      (message "smtpmail-smtp-server %s" smtpmail-smtp-server)
      (message "smtpmail-smtp-service %d" smtpmail-smtp-service)
      (message "smtpmail-stream-type %s" smtpmail-stream-type)
      (message "smtpmail-local-domain %s" smtpmail-local-domain))))
