...
\(fn BUFFERS-FILES &optional (NO-AND current-prefix-arg) (NAME \"helm-org-ql\"))" t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-org-ql" '("helm-org-ql-")))
