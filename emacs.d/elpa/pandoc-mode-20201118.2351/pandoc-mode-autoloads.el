...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pandoc-mode-utils" '("base-header-level" "bibliography" "citation-abbreviations" "columns" "csl" "def" "dpi" "email-obfuscation" "eol" "epub-chapter-level" "highlight-style" "id-prefix" "indented-code-classes" "ipynb-output" "jsmath" "katex" "latex" "mathjax" "mimetex" "number-offset" "pandoc-" "pdf-engine" "reference-location" "resource-path" "shift-heading-level-by" "slide-level" "tab-stop" "title-prefix" "track-changes" "webtex" "wrap")))
