;;; ox-tufte-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(autoload 'org-tufte-export-to-buffer "ox-tufte" "\
...
(autoload 'org-tufte-export-to-file "ox-tufte" "\
...
(autoload 'org-html-publish-to-tufte-html "ox-tufte" "\
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-tufte" '("org-tufte-")))
