...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-org-ql" '("helm-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-ql" '("peg-" "org-ql-")))
