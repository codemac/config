(custom-set-variables
 ...
 '(package-selected-packages
   '(geiser-chez geiser-chicken geiser-guile geiser-racket rmsbolt literate-calc-mode lsp-dart emacsql-sqlite sqlite3 xterm-color org-roam counsel helm-org-rifle wgrep gnuplot clipetty chronos yasnippet gmail-message-mode org-ql org-sidebar ivy-bibtex ace-jump-mode olivetti writeroom-mode org slime with-editor use-package projectile elfeed poet-theme racket-mode calfw calfw-org edit-server ox-tufte deft sauron mixed-pitch messages-are-flowing async auto-complete bbdb clojure-mode flycheck git-commit go-mode haskell-mode hydra impatient-mode minimap multiple-cursors pandoc-mode paredit rust-mode skewer-mode solarized-theme spinner undo-tree xcscope zenburn-theme android-mode htmlize goto-chg f epl plantuml-mode weechat org-tree-slide sr-speedbar avy cider ivy org-board vlf tup-mode smtpmail-multi simple-mpc queue puml-mode pretty-mode perspective pcmpl-git muse mode-compile mingus markdown-mode mark-multiple magit lua-mode load-theme-buffer-local js2-mode iasm-mode gtags go-eldoc geiser flycheck-tip fill-column-indicator expand-region evil ess-smart-underscore ess-R-object-popup ess-R-data-view erc-image epresent emms elfeed-org diffscuss-mode diff-hl d-mode command-frequency centered-window-mode buffer-move auctex))
