(custom-set-variables
 ...
 '(package-selected-packages
   '(diminish projectile evil-collection lsp-mode magit ace-window org-super-agenda org-ql org-contrib pandoc-mode ox-tufte org geiser-chez geiser-chicken geiser-guile geiser-racket literate-calc-mode lsp-dart emacsql-sqlite sqlite3 xterm-color org-roam counsel helm-org-rifle wgrep gnuplot clipetty chronos yasnippet gmail-message-mode org-sidebar ivy-bibtex ace-jump-mode use-package elfeed poet-theme calfw calfw-org edit-server deft sauron mixed-pitch messages-are-flowing async auto-complete bbdb clojure-mode flycheck go-mode haskell-mode hydra impatient-mode minimap multiple-cursors paredit rust-mode skewer-mode spinner undo-tree xcscope zenburn-theme android-mode htmlize goto-chg f epl plantuml-mode weechat org-tree-slide sr-speedbar avy cider ivy org-board vlf tup-mode smtpmail-multi simple-mpc queue puml-mode pretty-mode perspective pcmpl-git muse mode-compile mingus mark-multiple lua-mode load-theme-buffer-local js2-mode iasm-mode gtags go-eldoc geiser flycheck-tip fill-column-indicator expand-region evil ess-smart-underscore ess-R-object-popup ess-R-data-view erc-image epresent emms elfeed-org diffscuss-mode diff-hl d-mode command-frequency centered-window-mode buffer-move auctex))
